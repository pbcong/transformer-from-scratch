...
class FeedForwardBlock(nn.Module):
    ...
    def forward(self, x):
        # (batch, seq_len, d_model) -> linear_1 -> (batch, seq_len, d_ff) -> linear_2 -> (batch, seq_len, model) : seq2seq
...
class MultiHeadAttentionBlock(nn.Module):
    def __init__(self, d_model: int, h: int, dropout: float) -> None:
        ...
        self.d_model = d_model
        self.h = h
        # the embedding dimension have to be divisible by the number of head we want
